...
import "../src/StackingFlex.sol";
import "../src/DOGA.sol";

contract StackingFlexTest is Test {
    StackingFlex public stackingFlex;
    DOGA public doga;
    address owner;
    ...
    constructor() {
        ...
        stackingFlex = new StackingFlex(address(doga), address(doga), walletRewardHolder, 365 days, 8, 100);
    ...
    function test_Sender_should_be_able_to_stack_Doga() public {
        doga.approve(address(stackingFlex), 100);
    ...
    function test_Sender_should_have_reward() public {
        ...
        StackingFlex.StakerStacking memory stackingInfo = stackingFlex.getStackingInfo(stackerUser);
    ...
    function test_Multiples_Stacking_should_update_the_reward() public {
        ...
        vm.warp(block.timestamp + 4 * 30 days);
        stackingInfo = stackingFlex.getStackingInfo(stackerUser);
    ...
    function test_having_several_users_with_several_stack_should_work() public {
        ...
        vm.warp(warpedTime + 2 * 30 days);
        stackingFlex.stake(100);
        StackingFlex.StakerStacking memory stackingInfo = stackingFlex.getStackingInfo(bisStackerUser);
